...
public class ShiftTypeDAO {
    ...
    public void saveShiftType(ShiftType shiftType){
        ...
        jdbcTemplate.update(sql, shiftType.getId(), shiftType.getName(), shiftType.getDescription(), shiftType.isActive(), shiftType.getCreatedAt(),
                shiftType.getUpdatedAt(), shiftType.getTimeZone(), shiftType.getTenantId());
    }
